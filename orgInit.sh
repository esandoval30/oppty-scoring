...
sfdx force:data:bulk:upsert -s Opportunity -w 60 -f data/AllOpportunities.csv -i External_ID__c
#open the scratch org -- https://login.salesforce.com/packaging/installPackage.apexp?p0=04t58000000SGw3
